        ...
        <div class="row">
            <div class="col-12">
                <div class="innerCntainer">
                    <h5 class="headerText">WELCOME Mr. Sanz TO CRYPTOZEN</h5>
                    <h2 class="headerText">Your Safe Path to Digital Crypto Buy.</h2>

                    <h3 class="headerText mt-3">Your Balance $9920.00</h3>
                    <button type="button" class="btn btn-success mt-2">Add Payment Method</button>
                </div>
            </div>
        </div>
