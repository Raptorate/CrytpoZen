        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <div class="image my-lg-3">
              <img src="img/user2-160x160.jpg" class="img-circle elevation-3" alt="User Image">
              <p class="mt-2">Mr. Sanz Joe</p>
              <small class="text text-primary">sanz778@gmail.com</small>
            </div>
            ...
            <div class="dropdown-divider"></div>
            <a href="#" class="dropdown-item dropdown-footer text-danger"><b><i class="fa fa-sign-out-alt"></i> Signout</b></a>
          </div>
        </li>
      </ul>
    </nav>
